    ...
    render() {
        ...
        if (this.props.loading === false) {
            let cards = this.props.cards.events.filter(event => {
                return (event.classifications[0].segment.name === 'Sports')
            })
            ...
            <div className='Events'>
                {(this.props.redirect === false) ? (
                    <Redirect to="/Details" />
                        ...
                        <>
                            <Header />
                            <img id='Banner' src='WorldCup.jpg' alt='Sports' />
...
export default connect(mapStateToProps, { fetchEvents, setID })(Sports);